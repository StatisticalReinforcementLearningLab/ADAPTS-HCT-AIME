...
turbo_link = "/Volumes/umms-sungchoi/ROADMAP_ALL"
...
for (user in users[1:86]){
    ...
    output_dir = sprintf("/Users/lsn/Desktop/Sun/project_dyad/simulations/simulation20230530_real_data_preprocessing/summary_stats/%s/%s.Rda", study_ID, user)
